...
export default function Eventlist() {
  ...
  const token = '667b7a9c0884d578a2c8fb0b0b571400a3ebd768';

  useEffect(() => {
    const url = `https://front.apirecette.digitick-ppe.com/v1.1/distribution/salesChannels/13357/calendar/day/${currentDate}?lang=fr`;
